...
-->
  <xd:doc scope="stylesheet">
    <xd:desc>
      ...
      <xd:p>Elle produit une seconde sortie dans le répertoire passé en paramètre</xd:p>
    </xd:desc>
  </xd:doc>
  ...
  <xsl:template match="/">
    ...
    <xsl:result-document href="{$outputDir}/result.xml">
      <xsl:copy-of select="$copie"/>
    </xsl:result-document>
    <xsl:copy-of select="$copie"/>
  </xsl:template>
  ...
  <xd:doc scope="component">
    <xd:desc>
      <xd:p>Recopie les balises et le textes, et procède au traitement de tous les fils (y compris
        les commentaires et les PI)</xd:p>
    </xd:desc>
  </xd:doc>
